        ...
        <Col lg="8">
          <div className="admin-container">
            ...
            <form onSubmit={createTour} className="admin-form">
              ...
              <input type="number" placeholder="Price" value={Math.floor(price)} min="0" onChange={(e) => setPrice(e.target.value)} required />
              <input type="number" placeholder="Max Seats" value={maxSeats} min="0" onChange={(e) => setMaxSeats(e.target.value)} required />
